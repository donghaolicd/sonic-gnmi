// Package logging provides shared low-level primitives used by pkg/interceptors
// and gnmi_server for structured JSON line emission, canonical gRPC status
// mapping, and peer type/address extraction.
//
